...
COLAB_GIT_LOGIN = env("COLAB_GIT_LOGIN")
COLAB_GIT_PASSWORD = env("COLAB_GIT_PASSWORD")
...
runserver:
	...
	python ./manage.py runserver 80 & ssh -i '/content/terra_gui/$(RSA_KEY)' -o StrictHostKeyChecking=no -R $(PORT):localhost:80 $(TUNNEL_USER)
