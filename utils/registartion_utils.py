...
def send_registration_mail(**kwargs):
    ...
    user = kwargs["user"]
    message = f"""Для использования сервиса необходимо пройти по ссылке https://colab.research.google.com/github/aiuniver/terra_reg/blob/production/notebooks/Terra-GUI.ipynb
